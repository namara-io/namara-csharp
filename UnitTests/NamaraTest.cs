...
namespace ThinkData
{
    ...
    public class NamaraTest
    {
        ...
        public void TestCreateBasicRequest()
        {
            ...
            Assert.AreEqual(request.RequestUri.AbsoluteUri, "http://api.namara.io/v0/data_sets/"+dataset+"/data/"+version+"?api_key=myapikey&");
        }
        ...
        public void TestCreateBasicRequestOffset()
        {
            ...
            Assert.AreEqual(request.RequestUri.AbsoluteUri, "http://api.namara.io/v0/data_sets/" + dataset + "/data/" + version + "?api_key=myapikey&offset=1&");
        }
        ...
        public void TestCreateBasicRequestLimit()
        {
            ...
            Assert.AreEqual(request.RequestUri.AbsoluteUri, "http://api.namara.io/v0/data_sets/" + dataset + "/data/" + version + "?api_key=myapikey&limit=1&");
        }
        ...
        public void TestCreateBasicRequestSelect()
        {
            ...
            Assert.AreEqual(request.RequestUri.AbsoluteUri, "http://api.namara.io/v0/data_sets/" + dataset + "/data/" + version + "?api_key=myapikey&select=facility_code&");
        }
        ...
        public void TestCreateBasicRequestWhere()
        {
            ...
            Assert.AreEqual(request.RequestUri.AbsoluteUri, "http://api.namara.io/v0/data_sets/" + dataset + "/data/" + version + "?api_key=myapikey&where=facility_code%3E1000&");
        }
        ...
        public void TestCreateBasicRequestSum()
        {
            ...
            Assert.AreEqual(request.RequestUri.AbsoluteUri, "http://api.namara.io/v0/data_sets/" + dataset + "/data/" + version + "/aggregation?api_key=myapikey&operation=sum(facility_code)&");
        }
        ...
        public void TestCreateBasicRequestCount()
        {
            ...
            Assert.AreEqual(request.RequestUri.AbsoluteUri, "http://api.namara.io/v0/data_sets/" + dataset + "/data/" + version + "/aggregation?api_key=myapikey&operation=count(*)&");
        }
        ...
        public void TestCreateBasicRequestMin()
        {
            ...
            Assert.AreEqual(request.RequestUri.AbsoluteUri, "http://api.namara.io/v0/data_sets/" + dataset + "/data/" + version + "/aggregation?api_key=myapikey&operation=min(facility_code)&");
        }
        ...
        public void TestCreateBasicRequestMax()
        {
            ...
            Assert.AreEqual(request.RequestUri.AbsoluteUri, "http://api.namara.io/v0/data_sets/" + dataset + "/data/" + version + "/aggregation?api_key=myapikey&operation=max(facility_code)&");
        }
